...
################################################################
# This is a generated script based on design: motor
#
...
proc create_root_design { parentCell } {
  ...
  set pos_pwm [ create_bd_port -dir O pos_pwm ]
  set raster_a [ create_bd_port -dir I raster_a ]
  set raster_b [ create_bd_port -dir I raster_b ]
  set raster_z [ create_bd_port -dir I raster_z ]
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net processing_system7_0_axi_periph_M00_AXI [get_bd_intf_pins motor_0/MOTOR_AXI] [get_bd_intf_pins processing_system7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net motor_0_dir [get_bd_ports dir] [get_bd_pins motor_0/dir]
  connect_bd_net -net motor_0_pos_pwm [get_bd_ports pos_pwm] [get_bd_pins motor_0/pos_pwm]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins motor_0/motor_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0_axi_periph/ACLK] [get_bd_pins processing_system7_0_axi_periph/M00_ACLK] [get_bd_pins processing_system7_0_axi_periph/S00_ACLK] [get_bd_pins rst_processing_system7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_processing_system7_0_100M/ext_reset_in]
  connect_bd_net -net raster_a_1 [get_bd_ports raster_a] [get_bd_pins motor_0/raster_a]
  connect_bd_net -net raster_b_1 [get_bd_ports raster_b] [get_bd_pins motor_0/raster_b]
  connect_bd_net -net raster_z_1 [get_bd_ports raster_z] [get_bd_pins motor_0/raster_z]
  connect_bd_net -net rst_processing_system7_0_100M_interconnect_aresetn [get_bd_pins processing_system7_0_axi_periph/ARESETN] [get_bd_pins rst_processing_system7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_processing_system7_0_100M_peripheral_aresetn [get_bd_pins motor_0/motor_axi_aresetn] [get_bd_pins processing_system7_0_axi_periph/M00_ARESETN] [get_bd_pins processing_system7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_processing_system7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs motor_0/MOTOR_AXI/MOTOR_AXI_reg] SEG_motor_0_MOTOR_AXI_reg

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   guistr: "# # String gsaved with Nlview 6.5.12  2016-01-29 bk=1.3547 VDI=39 GEI=35 GUI=JA:1.6
#  -string -flagsOSRD
preplace port raster_b -pg 1 -y 450 -defaultsOSRD
preplace port DDR -pg 1 -y 40 -defaultsOSRD
preplace port dir -pg 1 -y 430 -defaultsOSRD
preplace port pos_pwm -pg 1 -y 410 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 60 -defaultsOSRD
preplace port raster_z -pg 1 -y 470 -defaultsOSRD
preplace port raster_a -pg 1 -y 430 -defaultsOSRD
preplace inst motor_0 -pg 1 -lvl 3 -y 420 -defaultsOSRD
...
preplace netloc motor_0_dir 1 3 1 NJ
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 260 370
preplace netloc rst_processing_system7_0_100M_peripheral_aresetn 1 1 2 390 470 NJ
preplace netloc raster_z_1 1 0 3 NJ 470 NJ 460 NJ
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ 60 NJ 60 NJ
preplace netloc raster_a_1 1 0 3 NJ 440 NJ 440 NJ
preplace netloc raster_b_1 1 0 3 NJ 450 NJ 450 NJ
preplace netloc rst_processing_system7_0_100M_interconnect_aresetn 1 1 1 370
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 250 380 430 690
preplace netloc motor_0_pos_pwm 1 3 1 NJ
levelinfo -pg 1 0 200 530 810 940 -top 0 -bot 520
",
}
