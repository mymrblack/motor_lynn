...
#
# Generated by Vivado on Fri Mar 31 14:58:29 +0800 2017
# IP Build 1577682 on Fri Jun  3 12:00:54 MDT 2016 
#
# usage: motor.sh [-help]
# usage: motor.sh [-lib_map_path]
# usage: motor.sh [-noclean_files]
# usage: motor.sh [-reset_run]
#
...
# executing this script. Please type 'motor.sh -help' for more information.
#
...
# Script info
echo -e "motor.sh - Script generated by export_simulation (Vivado v2016.2 (64-bit)-id)\n"
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/motor/ip/motor_processing_system7_0_0/sim/motor_processing_system7_0_0.v" \
  2>&1 | tee -a vlogan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/motor/ip/motor_rst_processing_system7_0_100M_0/sim/motor_rst_processing_system7_0_100M_0.vhd" \
  2>&1 | tee -a vhdlan.log

  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/motor/hdl/motor.v" \
    "$ref_dir/../../../bd/motor/ipshared/xilinx.com/motor_v2_0/hdl/motor_v2_0_MOTOR_AXI.v" \
    "$ref_dir/../../../bd/motor/ipshared/xilinx.com/motor_v2_0/hdl/motor_v2_0.v" \
    "$ref_dir/../../../bd/motor/ip/motor_motor_0_0/sim/motor_motor_0_0.v" \
  2>&1 | tee -a vlogan.log
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" +incdir+"$ref_dir/../../../ipstatic/processing_system7_bfm_v2_0/hdl" \
    "$ref_dir/../../../bd/motor/ip/motor_auto_pc_0/sim/motor_auto_pc_0.v" \
  2>&1 | tee -a vlogan.log
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.motor xil_defaultlib.glbl -o motor_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./motor_simv $vcs_sim_opts -do simulate.do
}
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./motor.sh -help\" for more information)\n"
        exit 1
      fi
...
reset_run()
{
  files_to_remove=(ucli.key motor_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc motor_simv.daidir)
...
check_args()
{
  if [[ ($1 == 1 ) && ($2 != "-lib_map_path" && $2 != "-noclean_files" && $2 != "-reset_run" && $2 != "-help" && $2 != "-h") ]]; then
    echo -e "ERROR: Unknown option specified '$2' (type \"./motor.sh -help\" for more information)\n"
    exit 1
  fi
